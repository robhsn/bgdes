...
function ArticleLink({ children }) {
  return (
    <div style={{
      ...
      <svg width="16" height="16" viewBox="0 0 40 40" fill="var(--color-statement-link-icon)" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0, marginRight: 16, marginTop: 4 }}>
        ...
        <div className="article-content">
          ...
          <div className="breadcrumb" data-role-id="ls-breadcrumb">
            <div className="breadcrumb__trail">
              <BreadcrumbPills course="Intro to Backgammon" lesson="Lesson 2" onNavigate={onNavigate} />
            </div>
            {!launchMvp && (
